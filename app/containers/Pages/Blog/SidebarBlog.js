    ...
    return (
      <div>
        ...
        <PapperBlock
          ...
          whiteBg
          noMargin
          desc="Consectetur adipiscing elit. Suspendisse sed urna in justo euismod condimentum."
        >
        ...
        >
          <div className={classes.albumRoot}>
            <List>
              <ListItem button>
                <ListItemText
                  primary="Curabitur egestas consequat "
                  secondary="Jan 9, 2014"
                />
              </ListItem>
              <ListItem button>
                <ListItemText
                  primary="Interdum et malesuada fames"
                  secondary="Jan 7, 2014"
                />
              </ListItem>
              <ListItem button>
                <ListItemText
                  primary="Pellentesque ullamcorper"
                  secondary="July 20, 2014"
                />
              </ListItem>
              <ListItem button>
                <ListItemText
                  primary="Quisque a consequat ante"
                  secondary="July 20, 2014"
                />
              </ListItem>
              <ListItem button>
                <ListItemText
                  primary="Donec dignissim odio ac"
                  secondary="July 20, 2014"
                />
              </ListItem>
              <ListItem button>
        ...
        >
          <List dense className={classes.profileList}>
            <ListItem button>
              ...
              <ListItemText
                primary="Harry Wells"
                secondary="in Vestibulum bibendum"
              />
            </ListItem>
            <ListItem button>
              <Avatar
            ...
            <ListItem button>
              ...
              <ListItemText
                ...
                secondary="Aenean sit amet magna"
              />
            </ListItem>
            <ListItem button>
              <Avatar
