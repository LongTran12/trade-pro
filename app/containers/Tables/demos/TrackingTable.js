...
const data = [
    ...
    createData(
        ...
        'whatshot',
        3450,
        'Quisque ut metus sit amet augue rutrum',
        50,
        'Warning'
    ),
    createData(
    ...
    createData(
        ...
        'book',
        4118,
        'Aenean sit amet magna vel magna',
        33,
        'Default'
    )
];
...
function TrackingTable(props) {
    ...
    return (
        <PapperBlock
            ...
            whiteBg
            desc="Monitoring Your Team progress. Tracking task, current progress, and task status here."
        >
                            ...
                            <TableRow key={n.id}>
                                ...
                                <TableCell>
                                    <div className={classes.taskStatus}>
                                        <Icon
                                            className={classNames(classes.taskIcon, getType(n.type))}
                                        >
                                            {n.type}
                                        </Icon>
                                        <a href="#">
