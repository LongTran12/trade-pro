...
const timelineData = [
    ...
    comments: [
      {
        ...
        date: "May, 29 2018",
        message:
          "OTFUND LÀ ĐƠN  VỊ Quỹ ĐẦU TIÊN TÍCH hợp Blockchain vào  DAPP GAME DIGITAL LOTTERY  and  DIGITAL TRADING, GAME ONLINE. HỌC VIện ACADEMY, Thương Mại Điện Tử SHARING ECONOMY  VÀ CHÍNH THỨC RA MẮT VÀO THÁNG 10",
      },
      {
        id: "1_2",
        from: "Jihan Doe",
  ...
  },
  {
    ...
    image: roadmap,
    content:
      "THÔNG BÁO QUỸ OTFUND CHÍNH THỨC  PHÁT HÀNH CỔ PHIẾU CHO  CỘNG ĐỒNG GIÁ OTF = 0.5 USD  ",
    liked: true,
    // comments: [
    //   {
    //     id: "2_1",
