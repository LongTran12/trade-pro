...
export default function reducer(state = initialImmutableState, action = {}) {
    switch (action.type) {
        ...
        case POST:
            return state.withMutations(mutableState => {
                mutableState
                    .update('dataTimeline', dataTimeline => dataTimeline.unshift(
        ...
        case TOGGLE_LIKE:
            return state.withMutations(mutableState => {
                ...
                mutableState.update('dataTimeline', dataTimeline => dataTimeline.setIn(
                    [index, 'liked'],
        ...
        case POST_COMMENT:
            return state.withMutations(mutableState => {
                mutableState
                    .update('dataTimeline', dataTimeline => dataTimeline.setIn(
