...
import { Input, withStyles, Button, SvgIcon, TextField, FormControl, Tooltip } from '@material-ui/core'
...
const InputCopyAddress = ({ classes }) => {
    ...
    useEffect(() => {
        const time = setTimeout(() => { setCopy(false); }, 1500);
    ...
    return (
        ...
        >
            <Wrap>
                ...
                <WrapCopy>
                    <Button onClick={() => { navigator.clipboard.writeText(domain + value); setCopy(true) }}>
                        <Tooltip title="copy">
