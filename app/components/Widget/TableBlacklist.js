...
import { Chip, Grid, Button, FormControl, Input, InputLabel } from "@material-ui/core";
            ...
            <div className={classes.rootTable}>
                <div className={classes.tableWrapper}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
                        <Button onClick={() => setOpen(true)} variant="contained" color="primary">Add Blacklist</Button>
                    </div>
                    {open && <Modal
                        title="Add BlackList"
                        visible={open}
                                        ...
                                        {columns.map((column, i) => {
                                            ...
                                            return (
                                                <TableCell key={i} align={column.align}>
                                                    ...
                                                    {column.hid &&
                                                        <Button variant="contained" color="primary" onClick={() => onRemove(value)}>Remove</Button>}
