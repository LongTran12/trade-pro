  ...
  return (
    <Card className={classNames(classes.cardProduct, isWidthUp('sm', width) && list ? classes.cardList : '')}>
      ...
      <CardActions className={classes.price}>
        {price2 > 0 ? <Typography variant="h5">
          <span>
            $
            {Number((price).toFixed(1)).toLocaleString()} - {Number((price2).toFixed(1)).toLocaleString()} Usdi
          </span>
        </Typography>
          :
          <Typography variant="h5">
            <span>
              $
          {Number((price).toFixed(1)).toLocaleString()} Usdi
        </span>
          </Typography>
        }
        {prevPrice > 0 && (
          <Typography variant="caption" component="h5">
            <span className={Type.lineThrought}>
              $
              {Number((prevPrice).toFixed(1)).toLocaleString()} Usdi
            </span>
          </Typography>
        )}
